  ...
  return (
    ...
    >
      <body className="min-h-full font-body">
        <a
          href="#main"
          className="skip-link sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[100] focus:rounded-sm focus:bg-accent focus:px-3 focus:py-2 focus:font-body focus:text-sm focus:text-white"
        >
          Skip to content
        </a>
        {children}
